...
void shopping:: receipt()
{
    ...
    if(!data)
    {
        ...
        cout<<"\n\n\t\t\t____________________________RECEIPT___________________________\n";
        cout<<"\nProducr No\t Product Name\t Product Quality\tprice\tAmount with discount\n";
